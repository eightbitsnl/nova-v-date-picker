...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-v-date-picker', __webpack_require__(3));
  Vue.component('detail-nova-v-date-picker', __webpack_require__(6));
  Vue.component('form-nova-v-date-picker', __webpack_require__(9));
});
